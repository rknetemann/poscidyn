...
Walk through the **Basic usage** pages in order:
  ...
  1. [Oscillator models](../usage/basic-usage/oscillator-models.md)
  2. [Excitation models](../usage/basic-usage/excitation-models.md)
  3. [Time response](../usage/basic-usage/time-response.md)
  4. [Frequency sweep](../usage/basic-usage/frequency-sweep.md)
