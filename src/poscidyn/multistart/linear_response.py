...
class LinearResponse(AbstractMultistart):
    ...
    def generate_simulation_grid(self, model, omegas):
        omegas = jnp.asarray(omegas)
        n_modes = model.n_modes
        max_displacement_per_mode = (model.Q / model.omega_0**2) * self.linear_response_factor
        max_velocity_per_mode = (model.Q / model.omega_0) * self.linear_response_factor
        ...
        return (omegas_mesh, x0_mesh, v0_mesh, shape)
