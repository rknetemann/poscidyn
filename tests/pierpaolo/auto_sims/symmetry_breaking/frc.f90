...
! ODEs for x and y
       ...
       F(2) = - (omega0x/Qx)*q2 - omega0x**2*q1 - z1 - 2*alpha*q1*q3 + fx*U(5)

       F(3) = q4

       F(4) = - (omega0y/Qy)*q4 - omega0y**2*q3 - z2 - alpha*q1*q1 + fy*U(5)
...
! ------------------------------------------------------------
      ...
      fy    = 0.03D0        ! forcing amplitude on y
