...
DRIVING_FREQUENCY = np.linspace(0.1, 1.75, 200)
DRIVING_AMPLITUDE = np.linspace(0.1 * REQUIRED_FORCE, 1.0 * REQUIRED_FORCE, 3)
...
SOLVER = oscidyn.TimeIntegrationSolver(max_steps=4096*20, n_time_steps=50, verbose=True, throw=False, rtol=1e-3, atol=1e-7)
