...
DRIVING_FREQUENCY = np.linspace(0.5, 2.0, 100)
...
SOLVER = oscidyn.TimeIntegrationSolver(max_steps=4096*10, n_time_steps=100, verbose=True, throw=False, rtol=1e-4, atol=1e-7)
