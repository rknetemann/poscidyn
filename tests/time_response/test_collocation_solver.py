...
SOLVER = oscidyn.CollocationSolver(max_steps=1000, N_elements=16, K_polynomial_degree=2, max_iterations=300, multistart=MULTISTART, verbose=True, rtol=1e-4, atol=1e-7, n_time_steps=500)
