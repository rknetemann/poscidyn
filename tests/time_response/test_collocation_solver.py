...
SOLVER = oscidyn.CollocationSolver(max_steps=1000, N_elements=32, K_polynomial_degree=4, max_iterations=500, multistart=MULTISTART, verbose=True, rtol=1e-9, atol=1e-12, n_time_steps=500, throw=True)
