...
DRIVING_AMPLITUDE = jnp.linspace(0.1*omega_0**2/Q, 1.0*omega_0**2/Q, 10)
SOLVER = oscidyn.FixedTimeSteadyStateSolver(max_steps=4_096*200, rtol=1e-4, atol=1e-9, progress_bar=True)
