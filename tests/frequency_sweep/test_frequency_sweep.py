...
DRIVING_AMPLITUDE = jnp.linspace(0.00001, 0.0001, 10)  # Shape: (n_driving_amplitudes,)
...
frequency_sweep = oscidyn.frequency_sweep(
    ...
    solver = oscidyn.FixedTimeSteadyStateSolver(max_steps=4_096*1, rtol=1e-6, atol=1e-7, progress_bar=False),
